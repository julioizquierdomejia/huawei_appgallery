...
<script>
	...
	v_type = "Gastro";
	ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Gastro_play');
	@else
	v_type = "Gym";
	ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Gastro_play');
	@endif
					...
					<div class="col-12 pt-3 pt-lg-5 page-title mt-md-5">
						...
						<div class="buttons mt-5 pt-md-5">
							<div class="b-content pt-md-5">
								<button class="btn btn-danger" onclick="ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Volver'); window.history.back();"><i class="fas fa-arrow-circle-left pr-2"></i> Volver</button>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-12 col-md-4 py-2">
							<div class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a onclick="ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Compartir_fb');" class="btn btn-facebook" href="https://www.facebook.com/sharer/sharer.php?u={{url()->current()}}" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
									<li><a onclick="ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Compartir_fb');" class="btn twitter-share-button" href="https://twitter.com/intent/tweet?text=Este%vídeo%20te%20encantará%20&#128154;:%20%0A{{url()->current()}}.%0A" target="_blank"><i class="fab fa-twitter"></i></a></li>
									<li><button onclick="ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Compartir_fb');" class="btn btn-pinterest" type="button"><i class="fab fa-pinterest"></i></button></li>
									{{-- <li><a onclick="ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Compartir_fb');" class="btn btn-linkedin" href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{url()->current()}}&title=Este%vídeo%20te%20encantará%20" target="_blank"><i class="fab fa-linkedin"></i></a></li> --}}
									<li><a onclick="ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Compartir_fb');" class="btn whatsapp-btn btn-whatsapp" target="_blank" data-text="Hola,%20te%20comparto%20nuestro%vídeo%20{{url()->current()}}" href="https://web.whatsapp.com/send?text=Hola,%20te%20comparto%20nuestro%vídeo%20%0A{{url()->current()}}"><i class="fab fa-whatsapp"></i></a></li>
									<li><a onclick="ga('send', 'event','HUAWEI_CLAROCLUB','Perfil_Esperiencia_'+v_type,'Compartir_fb');" class="btn" href="mailto:?subject=Te invito a ver este vídeo&amp;body=Este vídeo te encantará &#9829;: %0A{{url()->current()}}.%0A%0A"><i class="fas fa-envelope"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
